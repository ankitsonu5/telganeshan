    ...
    <main>
        ...
        <section class="section">
            <div class="content-wrapper">
                ...
                <?php
                // Get all albums
                // hide_empty is false so user can see their freshly created albums even if empty
                ...
                <?php else : ?>
                    <div style="text-align: center; padding: 4rem 0;">
                        ...
                        <h3 style="margin-bottom: 1rem;">No Albums Found</h3>
                        <p>Go to <strong>Gallery > Albums</strong> in your dashboard to create your first album.</p>
                    </div>
                <?php endif; ?>
